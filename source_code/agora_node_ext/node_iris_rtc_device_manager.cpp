...
// const char* NodeIrisRtcDeviceManager::_class_name =
// "NodeIrisRtcDeviceManager"; const char*
// NodeIrisRtcDeviceManager::_ret_code_str = "retCode"; const char*
// NodeIrisRtcDeviceManager::_ret_result_str = "result";
...
//     return instance;
// }
// napi_value NodeIrisRtcDeviceManager::New(napi_env env, napi_callback_info
// info) {
//     napi_status status;
//     napi_value jsthis;
...
//     auto deviceManager = new NodeIrisRtcDeviceManager(env,
//     _staticDeviceManager); deviceManager->_env = env; status = napi_wrap(env,
//     jsthis, reinterpret_cast<void*>(deviceManager),
...
//     napi_value cons;
//     status = napi_define_class(env, _class_name, NAPI_AUTO_LENGTH, New,
//     nullptr,
//                                3, properties, &cons);
//     assert(status == napi_ok);
...
// napi_value NodeIrisRtcDeviceManager::CallApiAudioDevice(napi_env env,
...
//                                                       (ApiTypeAudioDeviceManager)_apiType,
//                                                       parameter.c_str(),
//                                                       result);
//     } else {
//         ret = ERROR_NOT_INIT;
...
// napi_value NodeIrisRtcDeviceManager::CallApiVideoDevice(napi_env env,
// napi_callback_info info) {
//     napi_status status;
//     size_t argc = 3;
//     napi_value args[3];
...
//     if (_deviceManager->_deviceManager) {
//         ret = _deviceManager->_deviceManager->CallApi(
//                                                       (ApiTypeVideoDeviceManager)_apiType,
//                                                       parameter.c_str(),
//                                                       result);
//     } else {
//         ret = ERROR_NOT_INIT;
...
// napi_value NodeIrisRtcDeviceManager::Release(napi_env env, napi_callback_info
// info) {
//     napi_status status;
