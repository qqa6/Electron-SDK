...
//     static napi_value CallApiAudioDevice(napi_env env, napi_callback_info
//     info); static napi_value CallApiVideoDevice(napi_env env,
//     napi_callback_info info); static napi_value Release(napi_env env,
